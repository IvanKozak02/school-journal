...
<div class="wrap">
    ...
    <div id="content">
        ...
        <#if isClassTeacher>
            ...
            <hr>
            <div class="cards" style="padding-left: 0.5rem;">
                <a class="single-card" href="/attendance-record/${attendanceJournal}">
                    <div>
                        <h1>${class}</h1>
                    </div>
                    <div>
                ...
                <div class="are-you-teacher-form">
                    <div class="teacher-form-container">
                        <div class="teacher-form_raw">
                            <h3 class="are-you-teacher-h3">Ви є одночасно вчителем?</h3>
                            <p class="are-you-teacher-p">Оберіть предмети, які ви викладаєте та станьте вчителем</p>
                            <button type="button" class="add-to-school">Обрати</button>
                        </div>
                    </div>
                </div>
            </div>
...
<div id="addTeacherToSchool" class="modal" style="z-index: 999;">
    <div class="modal-content" style="background: #fff; padding: 0 40px 40px;
    border-radius: 8px; margin: 25px auto; width:565px; min-height: 400px">
        <h1><span class="add-column-text" style="margin-right: 10px; font-size: 25px; letter-spacing: 2px; text-align: center; padding-top: 25px; padding-bottom: 25px">Обрання предметів</span></h1>
        <div class="content-container">
            <div class="class-information">
                <form action="#" id="form-connect-teacher" onsubmit="return false">
                    <div style="display: flex" class="input-cont-teacher">
                        <label class="mandatory">Предмети, які викладаються у школі</label>
                        <select class="mandatory" name="subjects" id="subjects" multiple>
                            <#list subjects as subject>
                                <option>${subject.name}</option>
                            </#list>
                        </select>
                    </div>
                    <div class="save-subject" style="padding-top: 150px;">
...
<#--</#if>-->
<script src="../static/js/saveAdminTeacher(v6).js"></script>
