...
<div class="transition-fade" id="swup">
  ...
  <div id="content" >
    <div class="header">
      <h1 style="padding-left: 40px; color: rgb(85,83,83);;">Зведена таблиця руху учнів класу</h1>
    ...
    <div class="sem-and-subject" style="padding-top: 20px">
      <div class="input-field class-name" style="padding-top: 15px; padding-left: 40px; width: 15%">
        <label> Клас
          <select onchange="getMotionTable()" class="class-teacher" style="width: 96%" required>
    ...
    <div class="img-container" style="align-items: center; flex-direction: column; display:flex;">
      ...
      <h1 class="class-user-name" style="padding-top: 30px;">Для відображення Таблиці руху учнів, оберіть клаc</h1>
    </div>
</div>
</div>
